...
class TS_Stripe {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      TS_Stripe_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ts-stripe-loader.php';
		...
		$this->loader = new TS_Stripe_Loader();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new TS_Stripe_Public( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_styles' );
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );

		//process payment action
		$this->loader->add_action('init', $plugin_public, 'ts_stripe_process_payment');
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    TS_Stripe_Loader    Orchestrates the hooks of the plugin.
	 */
